...
public class EngagementApp extends WebMvcConfigurerAdapter {

    private static final Logger log = LoggerFactory.getLogger(EngagementApp.class);
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(EngagementApp.class);
