...
import com.tm.engagement.service.dto.ContractorEmployeeEngagementView;


public class EmployeeEngagementCommand {

	private final Logger log = LoggerFactory.getLogger(EmployeeEngagementCommand.class);
	...
	public EmployeeEngagementCommand(RestTemplate restTemplate, String comtrackServiceUrl, String token, Long userId,
			String engagementId) {
	...
	public ContractorEmployeeEngagementView getEmployeeEngagementDetails() {
		...
		try{
			log.info(""+
					comtrackServiceUrl + COMTRACK_HOLIDAY_URI + "?userId=" + userId
		...
		if (resp.getStatusCode() == HttpStatus.OK) {
			...
			log.error("Error collecting from employee engagement common-services.",ex);
		}
		return null;
