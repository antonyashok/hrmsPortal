...
@Relation(value = "BillingQueues", collectionRelation = "BillingQueues")
public class BillingQueueDTO extends ResourceSupport implements Serializable {

    private static final long serialVersionUID = -7969146310690975662L;

    public enum TaxExempt {
        Y, N
    }
    
    private String billingQueueId;
    ...
    private List<TaskDTO> subTasksDetails;
    ...
    private Double cappedMaxSTHours;
    private Double cappedMaxOTHours;
    private Double cappedMaxDTHours;
    ...
    private String contractorMailId;
    
	public String getBillingQueueId() {
		return billingQueueId;
	}
	public void setBillingQueueId(String billingQueueId) {
		this.billingQueueId = billingQueueId;
	}
	...
	public List<TaskDTO> getSubTasksDetails() {
		return subTasksDetails;
	}
	public void setSubTasksDetails(List<TaskDTO> subTasksDetails) {
	...
	public Double getCappedMaxSTHours() {
		return cappedMaxSTHours;
	}
	public void setCappedMaxSTHours(Double cappedMaxSTHours) {
		this.cappedMaxSTHours = cappedMaxSTHours;
	}
	public Double getCappedMaxOTHours() {
		return cappedMaxOTHours;
	}
	public void setCappedMaxOTHours(Double cappedMaxOTHours) {
		this.cappedMaxOTHours = cappedMaxOTHours;
	}
	public Double getCappedMaxDTHours() {
		return cappedMaxDTHours;
	}
	public void setCappedMaxDTHours(Double cappedMaxDTHours) {
	...
	public String getContractorMailId() {
		return contractorMailId;
	}
	public void setContractorMailId(String contractorMailId) {
		this.contractorMailId = contractorMailId;
	}
}
