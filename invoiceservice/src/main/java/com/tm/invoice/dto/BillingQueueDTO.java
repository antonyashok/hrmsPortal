...
import com.tm.invoice.mongo.domain.BillingQueue.TaxExempt;
...
public class BillingQueueDTO extends ResourceSupport implements Serializable {
    ...
    private static final String ENGAGEMENT_BLANK_ERROR_MESSAGE = "Engagement Id Cannot be Empty";
    private static final String EMPLOYEE_BLANK_ERROR_MESSAGE = "Employee Id Cannot be Empty";

    private UUID billingQueueId;
    private String billingProfile;
    @NotBlank(message = ENGAGEMENT_BLANK_ERROR_MESSAGE)
    private String engagementId;
    @NotBlank(message = EMPLOYEE_BLANK_ERROR_MESSAGE)
	...
	public UUID getBillingQueueId() {
		return billingQueueId;
	}
	public void setBillingQueueId(UUID billingQueueId) {
