...
public class PoNotExistException extends RuntimeException {

    private static final long serialVersionUID = 5588555146374095023L;

    public PoNotExistException(String exceptionMessage) {
        super(exceptionMessage);
    }
    
    public PoNotExistException(final String msg, final Throwable cause) {
		super(msg, cause);
	}
