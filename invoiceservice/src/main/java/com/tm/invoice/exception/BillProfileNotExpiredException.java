...
public class BillProfileNotExpiredException extends RuntimeException {

    private static final long serialVersionUID = 5588555146374095023L;

    public BillProfileNotExpiredException(String exceptionMessage) {
        super(exceptionMessage);
    }
    
    public BillProfileNotExpiredException(final String msg, final Throwable cause) {
		super(msg, cause);
	}
