...
public class PoAlreadyExistException extends RuntimeException {

    private static final long serialVersionUID = 5588555146374095023L;

    public PoAlreadyExistException(String exceptionMessage) {
        super(exceptionMessage);
    }
    
    public PoAlreadyExistException(final String msg, final Throwable cause) {
		super(msg, cause);
	}
