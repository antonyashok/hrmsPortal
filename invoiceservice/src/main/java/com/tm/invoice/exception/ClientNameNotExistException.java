...
public class ClientNameNotExistException extends RuntimeException {

    private static final long serialVersionUID = 5588555146374095023L;

    public ClientNameNotExistException(String exceptionMessage) {
        super(exceptionMessage);
    }
    
    public ClientNameNotExistException(final String msg, final Throwable cause) {
		super(msg, cause);
	}
