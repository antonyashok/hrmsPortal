 ...
 * <pre>
 *
 * File          : com.tm.invoice.InvoiceApp.java
 * Author        : Annamalai L
 * Date Created  : Apr 4th, 2017
 * 
...
@EnableJpaRepositories(basePackages = "com.tm.invoice")
@EnableMongoRepositories(basePackages = "com.tm.invoice.mongo")

public class InvoiceApp extends WebMvcConfigurerAdapter {

	private static final Logger log = LoggerFactory
			.getLogger(InvoiceApp.class);
