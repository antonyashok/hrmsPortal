...
@Document(collection = "contractorBillDetails")
public class PendingBillingQueueDetails extends BaseAuditableEntity implements IEntity<ObjectId> {

    private static final long serialVersionUID = 4792565371721992186L;
