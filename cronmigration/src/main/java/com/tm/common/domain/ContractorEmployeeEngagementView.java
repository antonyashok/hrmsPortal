...
public class ContractorEmployeeEngagementView implements Serializable {
	...
	private String hiringManagerMail;
	...
	public String getHiringManagerMail() {
		return hiringManagerMail;
	}

	public void setHiringManagerMail(String hiringManagerMail) {
		this.hiringManagerMail = hiringManagerMail;
	}
