...
public class InvoiceConstants {
    ...
    public static final String APPLICATION_SPREAD_SHEET =
    ...
    public static final String INVOICE_POATTACHMENT_MONGO_COLLECTION =
            "invoicePOAttachmentsCollection";
    public static final String INVOICE_ID = "invoiceId";
    public static final String FILE_UPLOAD_ERROR_MESSAGE =
            "File uploading Error Occur:File size may > 2MB or Number Files May > 5";
    ...
    public static final String TASK_IS_ALREADY_PRESENT_FOR_THIS_CONTRACTOR =
            "Task is already Exists";
    public static final String PENDING_BILLING_QUEUE_ATTACHMENT_ID = "attachmentId";
    public static final String INVOICE_PENDING_BILLING_QUEUEATTACHMENT_MONGO_COLLECTION =
            "pendingBillingQueueAttachments";
    ...
    public static final String BILLING_SPECILIST_ID = "billingSpecilistId";
    ...
    public static final String PENDING_BILLING_QUEUE_FILES_DETAILS =
            "pendingBillingQueueFiles Details";
    ...
    public static final String EFFECTIVE_DATE_IS_DUPLICATE_FOR_THIS_TASK =
            "Effective Date Is Duplicate For This Project";
    ...
    public static final String HIRINGMANAGER_BLANK_ERROR_MESSAGE =
            "Hiring manager can not be empty";
    public static final String TIMESHEETTYPE_REQUIRED_ERROR_MESSAGE = "Time sheet type required";
    public static final String TIMESHEETTYPE_BLANK_ERROR_MESSAGE =
            "Time sheet type can not be empty";

    public static final String NO_CONFIGURATION_WAS_SET =
            "No configuration was set for this invoice";
    ...
    public static final String UPDATION_FAILED_BECAUSE_SOME_DATA_ARE_NOT_STORED =
            "Updation has been failed to edit InvoiceSetup because some data are Not Properly saved";
    public static final String BILL_TO_MANAGER_LIST = "BillTOManagerList";

    public static final String BILLINGPROFILE_SAVED_SUCCESSFULLY =
    ...
    public static final String INVOICE_SETUP_UPDATED =
            "Invoice Setup has been updated successfully";
    public static final String INVOICE_SETUP_SUBMITTED =
            "Invoice Setup has been submitted successfully";
    public static final String INVOICE_SETUP_APPROVED =
            "Invoice Setup has been approved successfully";
    public static final String INVOICE_SETUP_BULK_APPROVED =
            "Invoice Setup(s) has been approved successfully";
    public static final String INVOICE_SETUP_REJECTED =
            "Invoice Setup has been rejected successfully";
    public static final String INVOICE_SETUP_BULK_REJECTED =
            "Invoice Setup(s) has been rejected successfully";
    public static final String INVOICE_SETUP_DEACTIVATED =
            "Invoice Setup has been deactivated sucessfully";
    public static final String INVOICE_SETUP_ACTIVATED =
            "Invoice Setup has been activated sucessfully";
    public static final String INVOICE_SETUP_PENDINGAPPROVAL =
            "Invoice Setup has been moved to Pending Approval";

    public static final String INVOICEBILLTOMANAGERADDRESS_ALREADYEXISTS =
            "Bill to manager address already exists";
    public static final String ASSIGNBILLTOMANAGER_ADDEDSUCCESSFULLY =
            "Assign bill to manager added successfully";
    public static final String ASSIGNBILLTOMANAGER_UPDATEDSUCCESSFULLY =
            "Assign bill to manager updated successfully";
    public static final String ASSIGNBILLTOMANAGER_DELETEDSUCCESSFULLY =
            "Assign bill to manager deleted successfully";

    public static final String NO_PO_RELATION_IS_FOUND =
            "No PO Relation is Found For This Contractor";
    public static final String NO_INVOICE_SET_UP_FOUND =
            "No Invoice Setup is Found For This Contractor";

    public static final String CONTRACTOR_DELETE_SUCCESS_MESSAGE =
            "The selected Contractor Successfully removed";
    public static final String CONTRACTOR_DELETE_FAILURE_MESSAGE =
            "Sorry couldn't Remove the selected Contractor";
    public static final String CLONE_INVOICE_SET_UP_FAILED_MESSAGE =
            "The Selected InvoiceSetup clone Process has been Failed";
    ...
    public static final String NO_BILL_TO_CLIENT_INFORMATION_FOUND_FOR_THIS_ENGAGEMENT =
            "No BillToClient Information Found For this Engagement";
    public static final String NO_BILL_TO_CLIENT_INFORMATION_FOUND =
            "No BillToClient Information Found";
    ...
    public static final String MILESTONEAMOUNT_BLANK_ERROR_MESSAGE =
            "mileStone Amount can not be empty";
    public static final String MILESTONEFIXEDAMOUNT_REQUIRED_ERROR_MESSAGE =
            "mileStone fixed Amount required";
    public static final String MILESTONEFIXEDAMOUNT_BLANK_ERROR_MESSAGE =
            "mileStone fixed Amount  can not be empty";
    public static final String MILESTONEFIXED_DATE_REQUIRED_ERROR_MESSAGE =
            "mileStone fixed date required";
    public static final String MILESTONEFIXED_DATE_BLANK_ERROR_MESSAGE =
            "mileStone fixed date can not be empty";
    ...
    public static final String PO_NUMBER_MAX_MIN_LIMIT =
            "poNumber cannot have more than 45 characters";
    ...
    public static final String REVENUESTARTDATE_BLANK_ERROR_MESSAGE =
            "revenueStartDate can not be empty";
    public static final String REVENUEENDDATE_REQUIRED = "revenueEndDate Required";
    public static final String REVENUEENDDATE_BLANK_ERROR_MESSAGE =
            "revenueEndDate can not be empty";
    ...
    public static final String FILENAME_MAX_MIN_LIMIT =
            "fileName cannot have more than 200 characters";
    ...
    public static final String TASKNAME_MAX_MIN_LIMIT =
            "taskName cannot have more than 50 characters";
    ...
    public static final String INVOICEMANAGERNAME_BLANK_ERROR_MESSAGE =
            "invoiceSetupManagerName can not be empty";
    public static final String INVOICEMANAGERADDR_REQUIRED = "invoiceSetupManagerAddress Required";
    public static final String INVOICEMANAGERADDR_BLANK_ERROR_MESSAGE =
            "invoiceSetupManagerAddress can not be empty";
    ...
    public static final String INVOICESETUPNAME_BLANK_ERROR_MESSAGE =
            "invoiceSetupName can not be empty";
    ...
    public static final String NO_END_CLIENT_INFORMATION_FOUND =
            "No End Client Information is Found";
    ...
    public static final String CLONED_SETUP_DELETED_SUCCESSFULLY =
            "Cloned Setup Deleted Successfully";
    ...
    public static final String STATUS_INVOICE_SETUP_NOT_APPROVAL_STR = "Invoice Setup Not Approval";
    ...
    public static final String DELIVERY_MODE_AUTO_DELIVERY = "Auto Delivery";
    public static final String DELIVERY_MODE_EMAIL = "Email";
    public static final String DELIVERY_MODE_POSTAL_SERVICE = "USPS";
