...
public class InvoiceEngineWriter implements ItemWriter<List<InvoiceDTO>> {

    private static final Logger log = LoggerFactory.getLogger(InvoiceEngineWriter.class);
