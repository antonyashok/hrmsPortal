...
//    public void sendHtmlMail(String to, String subject, String tempPassword, EmailSettings emailSettings, String userName)
      public void sendHtmlMail(String to, String subject, EmailSettings emailSettings, String message)
            throws Exception {
    	log.info("Processing request to send mail " + CONTEXT_PATH_URL);
//    	String mailMessage = emailSettings.getBodyContent();
    	String mailMessage = "";
...
//				.mergeTemplateWithData(mailMessage, metaEmailContent); 
