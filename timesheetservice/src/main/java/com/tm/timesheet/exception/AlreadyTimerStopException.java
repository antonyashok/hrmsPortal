...
public class AlreadyTimerStopException extends RuntimeException {

    private static final long serialVersionUID = 5588555146374095023L;

    public AlreadyTimerStopException(String exceptionMessage) {
        super(exceptionMessage);
    }
    
    public AlreadyTimerStopException(final String msg, final Throwable cause) {
		super(msg, cause);
	}
