...
public class InvalidStausCheckedException extends RuntimeException {

    private static final long serialVersionUID = 5588555146374095023L;

    public InvalidStausCheckedException(String exceptionMessage) {
        super(exceptionMessage);
    }
    
    public InvalidStausCheckedException(final String msg, final Throwable cause) {
		super(msg, cause);
	}
