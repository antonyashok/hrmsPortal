 ...
 * <pre>
 *
 * File          : com.tm.timesheet.web.rest.errors.EndDateEmptyExceptionTranslator2.java
...
@ControllerAdvice
public class EndDateEmptyExceptionTranslator2 {
  
  private MessageSourceAccessor accessor;

  private static final String WORKED_HOURS_EXCEED = "end.date.empty";

  public EndDateEmptyExceptionTranslator2(MessageSource messageSource) {
      accessor = new MessageSourceAccessor(messageSource);
  }
  
  @ExceptionHandler(EndDateEmptyException.class)
  public ResponseEntity<ErrorVM> processException(EndDateEmptyException ex) {
