 ...
 * <pre>
 *
 * File          : com.tm.timesheet.web.rest.errors.BreakHoursExceedExceptionTranslator.java
...
@ControllerAdvice
public class BreakHoursExceedExceptionTranslator {
  
  private MessageSourceAccessor accessor;

  private static final String WORKED_HOURS_EXCEED = "break.hours.exceed";

  public BreakHoursExceedExceptionTranslator(MessageSource messageSource) {
      accessor = new MessageSourceAccessor(messageSource);
  }
  
  @ExceptionHandler(BreakHoursExceedException.class)
  public ResponseEntity<ErrorVM> processException(BreakHoursExceedException ex) {
