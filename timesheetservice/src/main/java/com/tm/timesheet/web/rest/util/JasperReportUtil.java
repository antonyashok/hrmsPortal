...
public class JasperReportUtil {
	 ...
	 * @return
	 */
	public final static byte[] createReportFromJasperTemplate(JRBeanCollectionDataSource datasource,
		...
		try {
			if (reportType.equalsIgnoreCase(PDF)) {
				bytes = JasperRunManager.runReportToPdf(templatePath, parameters, datasource);
			}
			if (reportType.equalsIgnoreCase(XLS) || reportType.equalsIgnoreCase(XLSX)) {
				ByteArrayOutputStream output = new ByteArrayOutputStream();
				jasperPrint = JasperFillManager.fillReport(templatePath, parameters, datasource);
	 ...
	 * @return
	 */
	public final static byte[] createReportFromJasperTemplateEmptyDatasoruce(JREmptyDataSource datasource,
	        String templatePath, String reportType, Map<String, Object> parameters) {
		JasperPrint jasperPrint;
