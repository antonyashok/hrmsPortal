 ...
 * <pre>
 *
 * File          : com.tm.timesheet.web.rest.errors.CommendsExceedExceptionTranslator.java
...
@ControllerAdvice
public class CommendsExceedExceptionTranslator {
  
  private MessageSourceAccessor accessor;

  private static final String WORKED_HOURS_EXCEED = "Worked Hours Exceed";

  public CommendsExceedExceptionTranslator(MessageSource messageSource) {
      accessor = new MessageSourceAccessor(messageSource);
  }
  
  @ExceptionHandler(CommendsExceedException.class)
  public ResponseEntity<ErrorVM> processException(CommendsExceedException ex) {
