 ...
 * <pre>
 *
 * File          : com.tm.timesheet.web.rest.errors.StartAndEndLessTimeExceedExceptionTranslator.java
...
public class StartAndEndLessTimeExceedExceptionTranslator {
  ...
  @ExceptionHandler(StartAndEndLessTimeExceedException.class)
  public ResponseEntity<ErrorVM> processException(StartAndEndLessTimeExceedException ex) {
