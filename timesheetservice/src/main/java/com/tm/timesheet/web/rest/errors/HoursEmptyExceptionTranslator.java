 ...
 * <pre>
 *
 * File          : com.tm.timesheet.web.rest.errors.HoursEmptyExceptionTranslator.java
...
@ControllerAdvice
public class HoursEmptyExceptionTranslator {
  
  private MessageSourceAccessor accessor;

  private static final String WORKED_HOURS_EXCEED = "hours.not.exist";

  public HoursEmptyExceptionTranslator(MessageSource messageSource) {
      accessor = new MessageSourceAccessor(messageSource);
  }
  
  @ExceptionHandler(HoursEmptyException.class)
  public ResponseEntity<ErrorVM> processException(HoursEmptyException ex) {
