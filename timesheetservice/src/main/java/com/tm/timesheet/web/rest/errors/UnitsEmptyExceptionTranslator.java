 ...
 * <pre>
 *
 * File          : com.tm.timesheet.web.rest.errors.UnitsEmptyExceptionTranslator.java
...
@ControllerAdvice
public class UnitsEmptyExceptionTranslator {
  
  private MessageSourceAccessor accessor;

  private static final String WORKED_HOURS_EXCEED = "units.not.exist";

  public UnitsEmptyExceptionTranslator(MessageSource messageSource) {
      accessor = new MessageSourceAccessor(messageSource);
  }
  
  @ExceptionHandler(UnitsEmptyException.class)
  public ResponseEntity<ErrorVM> processException(UnitsEmptyException ex) {
