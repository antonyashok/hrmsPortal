...
public class SubmitterTimesheetViewResource {
	...
	public static final String TIMESHEET_TYPE = "Submitter";

	@Inject
	public SubmitterTimesheetViewResource(TimesheetViewService timesheetViewService,
	...
	@ApiOperation(value = "Getting the status count", notes = "This will get timesheets status count of a particular Employee")
	...
	public TimesheetStatusCountSummary getStatusCount(@RequestParam String startDate, @RequestParam String endDate,
		...
		TimesheetStatusCountSummary result = timesheetViewService.getStatusCount(TimesheetViewConstants.SUBMITTER,
				startDate, endDate, null, searchParam, TIMESHEET_TYPE);
		return timesheetStatusViewResourceAssembler.toSubmitterStatusCountResource(result);
	}
	...
	public PagedResources<TimesheetDTO> getAllMyTimesheets(Pageable pageable,
		...
		result = timesheetViewService.getAllTimesheets(pageable, status, startDate, endDate, searchParam,
				TimesheetViewConstants.SUBMITTER, null, null, TIMESHEET_TYPE);
