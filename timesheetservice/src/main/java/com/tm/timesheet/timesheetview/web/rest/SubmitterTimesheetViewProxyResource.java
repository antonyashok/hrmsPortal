...
@RestController
@RequestMapping(value = "/my-timesheets-proxy")
@Api(value = "my-timesheets-proxy", produces = MediaType.APPLICATION_JSON_VALUE,
        consumes = MediaType.APPLICATION_JSON_VALUE)
public class SubmitterTimesheetViewProxyResource {
	...
	@Inject
	public SubmitterTimesheetViewProxyResource(TimesheetViewService timesheetViewService,
	...
	// @RequiresAuthority({VIEW_MY_TIMESHEET})
	...
	public TimesheetStatusCountSummary getStatusCount(@RequestParam String startDate,
            @RequestParam String endDate,@RequestParam(required=true) String employeeType,@RequestParam String searchParam) throws ParseException {
    ...
    @ApiOperation(value = "Getting All Timesheets",
            notes = "This will get all timesheets of a particular Employee.")
    ...
    public PagedResources<TimesheetDTO> getAllMyTimesheets(Pageable pageable,
            ...
            String searchParam, String status,@RequestParam(required=true) String employeeType) throws ParseException {
    ...
    @ApiOperation(value = "Getting the activity logs",
            notes = "This will get all the activity logs.")
    ...
    @ApiOperation(value = "Getting the timesheet comments",
            notes = "This will get all the timesheet comments.")
    ...
    @ApiOperation(value = "upload Timesheet's attachments",
            notes = "This will upload timesheet's attachments of a particular Employee.")
    ...
    public List<TimesheetAttachmentsDTO> getTimesheetFileDetails(
            @PathVariable("timesheetId") UUID timesheetId) throws FileUploadException {
