...
@Relation(value = "report", collectionRelation = "reports")
public class TimesheetMonthlySummaryReportDTO implements Serializable {

    private static final long serialVersionUID = -1073596724943699284L;
