...
public class InvoiceSetupException extends RuntimeException {
    ...
    public InvoiceSetupException(String exceptionMessage) {
        super(exceptionMessage);
    }

    public InvoiceSetupException(final String msg, final Throwable cause) {
        super(msg, cause);
