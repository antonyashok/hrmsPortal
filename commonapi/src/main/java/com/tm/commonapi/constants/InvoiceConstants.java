package com.tm.commonapi.constants;
...
public class InvoiceConstants {
	...
	public static final String EXCEPTION_DETAIL_REJECT_COMMMENTS= "invoiceExceptionDetail.rejectComments";
	...
	public static final String LINE_OF_BUSINESS_NAME = "lineOfBusinessName";
    ...
    public static final String DP_SAVED_SUCCESSFULLY =
            "Direct Placement Saved Successfully";
    ...
    public static final String MANUAL_INVOICE_STR = "Manual"; 
    ...
    public static final Integer NUMBER_FORMAT_PREFIX_POSITION = 0;
    public static final Integer NUMBER_FORMAT_STARTING_NUMBER_POSITION = 1;
    public static final Integer NUMBER_FORMAT_SUFFIX_POSITION = 2;
    
    public static final Integer TOTAL_NUMBER_FORMAT_PARTS = 3;
    public static final Integer TOTAL_NUMBER_FORMAT_PARTS_HYPHEN = 4;
    
    public static final String YEAR_STR = "YEAR";
    public static final String MONTH_STR = "MONTH";
    public static final String YEAR_MONTH_STR = "YEAR-MONTH";
    public static final String USD = "USD";
    public static final String ACTIVE_FLG = "active";
    public static final String PO_AMOUNT = "purchaseOrderAmount";
