...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "system@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "MISSING SWAGGER TITLE PROPERTY";

        private String description = "MISSING SWAGGER DESCRIPTION PROPERTY";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "MISSING GRAPHITE PREFIX PROPERTY";
